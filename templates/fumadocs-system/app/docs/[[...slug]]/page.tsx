...
import { DocsCopyPage, DocsTableOfContents, flattenPageTree, type PageTreeNode } from "@/fumadocs-system";
...
export default async function DocsPageRoute({ params }: DocsPageProps) {
  ...
  const orderedPages = flattenPageTree((source.getPageTree()?.children ?? []) as PageTreeNode[]);
