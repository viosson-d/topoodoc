...
<Tabs defaultValue="radix">
  <TabsList>
    ...
    <TabsTrigger value="base">Base UI</TabsTrigger>
  </TabsList>
...
To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/topooui/rtl).
...
See the [Radix UI](https://www.radix-ui.com/primitives/docs/topooui/components/accordion#api-reference) documentation for more information.
  </TabsContent>
